...
class Account:
    ...
    def __init__(self, account_number, balance, interest_rate, loan_balance):
...
# Add a method check_balance which returns the account’s balance
    def check_balance(self):
        return self.balance
# Update the deposit method to append each withdrawal transaction to 
# the deposits list. Each transaction should be in form of a dictionary like this  
# {
#    "amount": amount,
#    "narration": “deposit”
# }
...
# to the withdrawals list. Each transaction should be in form of a dictionary like like this 
# {
#    "amount": amount,
...
# }
    ...
    def withdraw(self, amount):
        if self.balance >= amount:
            return f"Insuficient funds, your current balance is ${self.balance}"
        else:
            self.balance -= amount
            transaction = {"amount": amount, "narration": "withdrawal"}
            self.withdrawals.append(transaction)
            return f"Your withdrwals of ${amount} was sucessful, your new balance is ${self.balance}"
